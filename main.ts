...
//lower case
let person_Name: string= "muhammad imran"
...
let names: string [] = ["ali", "anees", "haseeb", "muzamil"];
console.log(names[0]);
console.log(names[1]);
console.log(names[2]);
console.log(names[3]);
...
let members:string[] = ['khwaja', 'jabir', 'bin', 'hayan'];
let message: string = 'do u like to play cricket:';
...
let transportation: string[] = ["honda motercycle", "CD 70 bike", "civic"];
...
let guestArr: string [] = ["Ali", "Anees", "Haseeb",];
guestArr.map((items) => (console.log(`Dear ${items} , you are inviyed at lunch`)));
...
// Original guest list
const guestList: string[] = ["Babar", "Sohail", "Tanveer"];
...
let placesToVisit: string[] = ["china", "pakistan", "japan"];
...
let person: {name: string, fname: string , age: number} = {name: "imran", fname: "male" , age: 21}
console.log(person);
...
let name_1: string = "Muhammad"
let name_2: string = "muhammad imran"
let name_3: string = "muhammad imran ali"
...
let favourite_pizza : string [] = ["California", "chicken", "veg"]
...
let animals : string [] = ["lion", "cat", "monkey"]
...
const magician: string[] = ["imran", "hamza", "bilal"]
